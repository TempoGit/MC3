...
//                worldGroup.position.x += 0.8
    ...
    ///
//    func spawnEnemy(){
//        let enemy = SKSpriteNode(imageNamed: "persona")
//        let actionMovement = SKAction.move(to: CGPoint(x: -enemy.size.width/2, y: enemy.position.y), duration: 2.0)
//        enemy.run(actionMovement)
//        let actionMoveRight = SKAction.move(to: CGPoint(x: -enemy.size.width, y: 0), duration: 10)
//        let wait = SKAction.wait(forDuration: 0.25)
//        let sequence = SKAction.sequence([actionMoveRight, wait, actionMovement])
//        enemy.run(sequence)
//
//        addChild(enemy)
//    }
